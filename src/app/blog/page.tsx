...
const POSTS = [
  ...
  {
    id: 1,
    title: "How to Calculate eBay Fees in 2026: The Complete Guide",
    excerpt: "Learn exactly how eBay's fee structure works, from insertion fees to final value fees, and how to protect your margins on every sale.",
    category: "Marketplace Strategies",
  ...
  {
    id: 2,
    title: "Poshmark vs Depop: Which Platform Pays More in 2026?",
    excerpt: "We break down the fee structures, seller tools, and profit margins across both platforms so you can make smarter selling decisions.",
  ...
  {
    id: 3,
    title: "StockX Fees Explained: What Sellers Need to Know",
    excerpt: "StockX charges both a seller fee and payment processing. Here's how to calculate your true profit before listing on the platform.",
    category: "Marketplace Strategies",
    author: "Priya Nair",
  ...
  {
    id: 4,
    title: "Top 10 Items to Resell for Maximum Profit in 2026",
    excerpt: "From sneakers to vintage electronics, discover which product categories offer the highest resale margins across all major platforms.",
  ...
  {
    id: 5,
    title: "How Mercari's New Fee Update Affects Your Profits",
    excerpt: "Mercari rolled out updated fees in early 2026. We analyze how the changes impact sellers and what you can do to stay profitable.",
  ...
  },
  {
    ...
    excerpt: "Etsy sellers face multiple overlapping fees. This guide walks through each one and shows you how to price for profit from day one.",
    category: "Fee Comparisons",
    author: "Priya Nair",
  ...
  {
    id: 7,
    title: "Cross-Platform Selling: How to Maximize Revenue Across 8 Marketplaces",
    excerpt: "Selling on multiple platforms means managing different fees, policies, and payouts. Here's how to build a profitable multi-channel strategy.",
    category: "Reselling Tips",
    author: "James Carter",
  ...
  {
    id: 8,
    title: "Amazon FBA vs FBM: True Profit Comparison for 2026",
    excerpt: "FBA offers convenience but comes with hidden costs. We run the numbers to show when FBM is actually the more profitable choice.",
    category: "Marketplace Strategies",
    author: "Sarah Mitchell",
